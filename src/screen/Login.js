...
render() {
  ...
  <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
  {
    ...
    <ActivityIndicator animatingsize="large" color="black" /> :
    <View>
    <Text style={{ color: 'grey', fontWeight: 'bold', fontSize: 24, paddingBottom: 30, backgroundColor: 'transparent' }}> React Chat </Text>
